...
#define USBD_VCPKYBRD_HID_IN_EPT                  0x82
...
typedef struct
{
  uint8_t g_rxhid_buff[USBD_VCPKYBRD_OUT_MAXPACKET_SIZE];
  uint8_t g_txhid_buff[USBD_VCPKYBRD_IN_MAXPACKET_SIZE];
...
}HID_compilation_type;     //vcp_keyboard_type
