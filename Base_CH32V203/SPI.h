...
#define SPI1_NSS_H()  GPIO_SPI1->BSHR = SPI1_NSS
#define SPI1_NSS_L()  GPIO_SPI1->BCR = SPI1_NSS
...
#define SPI2_NSS_H()  GPIO_SPI2->BSHR = SPI2_NSS
#define SPI2_NSS_L()  GPIO_SPI2->BCR = SPI2_NSS
