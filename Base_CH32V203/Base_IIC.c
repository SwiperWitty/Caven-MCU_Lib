...
void Base_IIC_Init(int set)
{
    ...
    if (set)
    {
        User_GPIO_config(GPIO_IIC,IIC_SCL,ENABLE);
        User_GPIO_config(GPIO_IIC,IIC_SDA,ENABLE);
    ...
    {
        User_GPIO_config(GPIO_IIC,IIC_SCL,DISABLE);
        User_GPIO_config(GPIO_IIC,IIC_SDA,DISABLE);
    }
#endif
}
